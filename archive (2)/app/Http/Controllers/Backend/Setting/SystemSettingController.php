...
class SystemSettingController extends Controller
{
    ...
    public function update(Request $request)
    {
        ...
        $setting->stripe_webhook_secret_subscription = $request->stripe_webhook_secret_subscription;
        $setting->stripe_webhook_secret_bulk = $request->stripe_webhook_secret_bulk;
