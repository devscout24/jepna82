            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header align-items-center d-flex">
                        <h4 class="card-title mb-0 flex-grow-1">Feature Edit</h4>
                    </div>
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.feature.update', $feature->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="title" class="form-control" id="title" value="{{ old('title', $feature->title) }}">
                                @error('title')
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="description" class="form-control summernote" id="description">{{ old('description', $feature->description) }}</textarea>
                                @error('description')
                                    <div class="text-danger small">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                @if($feature->icon)
                                    <div class="mb-2">
                                        <img src="{{ asset('storage/' . $feature->icon) }}" alt="Current Icon" style="max-width:100px;height:auto;border-radius:4px;">
                                    </div>
                                @endif
