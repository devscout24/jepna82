            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between bg-galaxy-transparent">
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">Subscribe Plan Create</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">Subscribe Plan Create</h4>
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('admin.subscribe_plan.store') }}">
                        @csrf
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="price_text" class="form-control" value="{{ old('price_text') }}">
                        </div>
